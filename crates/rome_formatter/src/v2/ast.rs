use super::format_element::Token;
use super::{normalize_newlines, Format, Formatter, LINE_TERMINATORS};
use crate::write;
...
trait FormatNode<L: Language>: Format {
    ...
    fn format_fields(&self, formatter: &mut Formatter) -> super::Result<()>;
}

impl<L: Language> Format for SyntaxToken<L> {
    fn format(&self, formatter: &mut Formatter) -> super::Result<()> {
        // Implement token trivia printing
